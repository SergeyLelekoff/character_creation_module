...
def attack(char_name: str, char_class: str) -> str:
    """Выводит наносимый персонажем урон"""
...
def defence(char_name: str, char_class: str) -> str:
    """Выводит заблокированный персонажем урон"""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выводит результат применения специального умения персонажем"""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функиция осуществляет выбор класса персонажа"""
    approve_choice = None
    char_class = None
